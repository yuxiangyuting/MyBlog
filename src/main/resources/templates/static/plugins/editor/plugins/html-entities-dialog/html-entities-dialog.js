/*!
 * HTML entities dialog static/plugin for Editor.md
 *
...
(function() {
	...
	var factory = function (exports) {
		...
		var $            = jQuery;
		var static/pluginName   = "html-entities-dialog";
		var selecteds    = [];
		var entitiesData = [];
		...
		exports.fn.htmlEntitiesDialog = function() {
			...
			var path        = settings.static/pluginPath + static/pluginName + "/";
			var editor      = this.editor;
			var cursor      = cm.getCursor();
			var selection   = cm.getSelection();
			var classPrefix = _this.classPrefix;

			var dialogName  = classPrefix + "dialog-" + static/pluginName, dialog;
			...
			{            
				...
				$.getJSON(path + static/pluginName.replace("-dialog", "") + ".json", function(json) {
