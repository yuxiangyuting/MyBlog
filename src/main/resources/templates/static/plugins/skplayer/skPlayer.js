...
let instance = false;
const baseUrl = 'https://www.music.yinpengfei.com/';
...
class skPlayer {
    ...
    init(){
        ...
        if(this.type === 'cloud'){
            Util.ajax({
                url: baseUrl + 'music?id=' + this.music[0].song_id,
                beforeSend: () => {
                },
                success: (data) => {
    ...
    switchMusic(index){
        ...
        if(this.type === 'file'){
            ...
            Util.ajax({
                url: baseUrl + 'music?id=' + this.music[index].song_id,
                beforeSend: () => {
                },
                success: (data) => {
                    let url = JSON.parse(data).url;
